...
func (table *Table) kingMove(sourceRow int8, sourceCol int8, targetRow int8, targetCol int8) bool {
	...
	if sourceRow == targetRow && (sourceCol-targetCol == 1 || sourceCol-targetCol == -1) { //left or right
		...
		return true
	} else if table.ChessBoard[sourceRow][sourceCol] == "wK" && table.ChessBoard[7][6] == "-" && table.ChessBoard[7][5] == "-" && sourceRow == targetRow && targetCol-sourceCol == 2 && table.canWhiteCastleKing() == true { //white king castle
		...
		return true
	} else if table.ChessBoard[sourceRow][sourceCol] == "wK" && table.ChessBoard[7][1] == "-" && table.ChessBoard[7][2] == "-" && table.ChessBoard[7][3] == "-" && sourceRow == targetRow && sourceCol-targetCol == 2 && table.canWhiteCastleQueen() == true { //white queen castle
		...
		return true
	} else if table.ChessBoard[sourceRow][sourceCol] == "bK" && table.ChessBoard[0][6] == "-" && table.ChessBoard[0][5] == "-" && sourceRow == targetRow && targetCol-sourceCol == 2 && table.canBlackCastleKing() == true { //black king castle
		...
		return true
	} else if table.ChessBoard[sourceRow][sourceCol] == "bK" && table.ChessBoard[0][1] == "-" && table.ChessBoard[0][2] == "-" && table.ChessBoard[0][3] == "-" && sourceRow == targetRow && sourceCol-targetCol == 2 && table.canBlackCastleQueen() == true { //black queenside castle
